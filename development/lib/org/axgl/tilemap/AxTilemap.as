package org.axgl.tilemap {
	...
	public class AxTilemap extends AxModel {
		...
		protected var _tileOffset:int = 1;
		...
		override public function draw():void {
			...
			var tx:Number = x - offset.x + parentOffset.x;
			var ty:Number = y - offset.y + parentOffset.y;
			...
			matrix.appendTranslation(Math.round(tx - cx + AxU.EPSILON), Math.round(ty - cy + AxU.EPSILON), 0);
